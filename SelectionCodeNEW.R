...
#..........................read in data..........................
points <- read_csv(here::here("GP2017jc.csv")) # should be N x k matrix where N is number of students and k is num of projects
proj_maximums <- read_csv(here::here("project_maximums.csv")) # should be k x 1 matrix
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
##  ~ updated version of the above code (but values begin to differ? don't use this for now)  ----
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# f <- t(fmat) %>% 
#   as.data.frame() %>% 
...
A0 <- diag(1, k) # k = 22, in the case of the 2017 class
A <- A0
